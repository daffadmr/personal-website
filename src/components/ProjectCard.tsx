...
const ProjectCard = ({
  ...
  return (
    <div className="card dark:bg-slate-700 max-w-md flex flex-col gap-2 shadow-xl rounded w-full border dark:border-0">
      {isMedium ? (
        image_url !== null ? (
          <Image
            src={image_url}
            ...
            unoptimized={true}
            alt={`${title}'s photo`}
            className="rounded-t min-h-[200px] max-h-[200px] w-auto"
            priority={true}
          />
        ) : (
          <svg
      ...
      <div className="py-7 px-4 flex flex-col gap-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <a
              href={repository_url}
              target="_blank"
              className="inline-block hover:bg-slate-400 dark:hover:bg-slate-500 hover:text-slate-100 dark:hover:text-slate-800  rounded"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
